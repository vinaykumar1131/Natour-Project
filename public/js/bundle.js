...
console.log("yes we got it"); // console.log(f);
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(name, email, password, conformpass) {
    var res;
...
var stripe = Stripe('pk_test_51MV7sESDULNH0Z1DlS3LSZtDQkGc3Er9MTpWQJBlO4rN7CXck75p0lMoDC4kDf9oYPN8xCrNcCxLLtci4mut3PH0005DlT4gTX');
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/user/updatepass' : 'http://127.0.0.1:3000/api/v1/user/updateme';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
  ...
  return function updateset(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var logoutbtn = document.getElementById('gg');
...
if (signupform) {
  signupform.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(name, Emails, password, ConformPassword);
  });
}

if (updatepass) {
  updatepass.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    _regeneratorRuntime().mark(function _callee(e) {
      var currentpass, password, conformpass;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            conformpass = document.getElementById('password-confirm').value;
            _context.next = 7;
            return (0, _updateSetting.updateset)({
...
if (updateuser) updateuser.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  form.append('photo', document.getElementById('photo').files[0]);
  (0, _updateSetting.updateset)(form, 'user');
});
